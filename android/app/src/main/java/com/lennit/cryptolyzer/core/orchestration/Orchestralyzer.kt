...
import com.lennit.cryptolyzer.core.model.ExecutionPolicy
...
class Orchestralyzer(
    ...
    private val policy: com.lennit.cryptolyzer.core.security.ExecutionPolicy
) {
    suspend fun evaluate(request: ExecutionRequest, mode: SystemMode): ExecutionDecision {
        ...
        val opportunity = Opportunity(
            id = com.lennit.cryptolyzer.core.model.OpportunityId(request.id.value),
